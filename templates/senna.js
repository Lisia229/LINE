export default {
  ...
  hero: {
    type: 'image',
    url: 'https://images.contentstack.io/v3/assets/blt370612131b6e0756/blt3bbb3f974de1bd16/60dcf917a1ff3159b5938fd7/Senna_Skin-02.jpg',
    size: 'full',
    aspectMode: 'cover',
    aspectRatio: '15:13'
  },
            ...
            contents: [
              ...
              },
              {
                ...
                contents: [
                  ...
                  {
                    type: 'image',
                    url: 'https://lolwildriftbuild.com/wp-content/uploads/2021/06/Bone_Plating_rune.png',
                    size: 'xxs',
                    position: 'absolute',
                    align: 'end',
                    gravity: 'top',
    ...
    contents: [
      {
        ...
        action: {
          type: 'uri',
          label: '英雄介紹',
          uri: 'https://wildrift.leagueoflegends.com/zh-tw/champions/senna/'
        },
        color: '#007acc'
      },
      {
        ...
        action: {
          type: 'uri',
          label: '出裝＆符文攻略',
          uri: 'https://lolwildriftbuild.com/champion/senna/'
        },
        color: '#007acc'
      },
      {
