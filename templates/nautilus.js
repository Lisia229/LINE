export default {
  ...
  hero: {
    type: 'image',
    url: 'https://images.contentstack.io/v3/assets/blt370612131b6e0756/bltc42e006a5d0bf473/62a921fcb53bb658a3926d32/Nautilus_Skin02_Splash.jpg',
    size: 'full',
    aspectMode: 'cover',
    aspectRatio: '15:13'
  },
        ...
        contents: [
          ...
          },
          {
            ...
            contents: [
              {
                type: 'image',
                url: 'https://lolwildriftbuild.com/wp-content/uploads/2020/10/Cloth-Armor.jpg',
                size: 'xxs',
                position: 'absolute',
                align: 'start',
                offsetStart: '0px'
    ...
    contents: [
      {
        ...
        action: {
          type: 'uri',
          label: '英雄介紹',
          uri: 'https://wildrift.leagueoflegends.com/zh-tw/champions/nautilus/'
        },
        color: '#715b6e'
      },
      {
        ...
        action: {
          type: 'uri',
          label: '出裝＆符文攻略',
          uri: 'https://lolwildriftbuild.com/champion/nautilus/'
        },
        color: '#715b6e'
      },
      {
