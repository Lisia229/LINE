export default {
  ...
  hero: {
    type: 'image',
    url: 'https://images.contentstack.io/v3/assets/blt370612131b6e0756/blt7fecc4ea9704ba83/60109b5a7957730fa57aaf58/Tristana_Skin03.jpg',
    size: 'full',
    aspectMode: 'cover',
    aspectRatio: '15:13'
  },
    ...
    contents: [
      {
        ...
        action: {
          type: 'uri',
          label: '英雄介紹',
          uri: 'https://wildrift.leagueoflegends.com/zh-tw/champions/tristana/'
        },
        color: '#715b6e'
      },
      {
        ...
        action: {
          type: 'uri',
          label: '出裝＆符文攻略',
          uri: 'https://lolwildriftbuild.com/champion/tristana/'
        },
        color: '#715b6e'
      },
      {
