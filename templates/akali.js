export default {
  ...
  hero: {
    type: 'image',
    url: 'https://images.contentstack.io/v3/assets/blt370612131b6e0756/blt52f9db57e8813c4c/5f9b3be0164ebf10ea202bbf/akali_skin03.jpg',
    size: 'full',
    aspectMode: 'cover',
    aspectRatio: '15:13'
  },
    ...
    contents: [
      {
        ...
        action: {
          type: 'uri',
          label: '英雄介紹',
          uri: 'https://wildrift.leagueoflegends.com/zh-tw/champions/akali/'
        },
        color: '#715b6e'
      },
      {
        ...
        action: {
          type: 'uri',
          label: '出裝＆符文攻略',
          uri: 'https://lolwildriftbuild.com/champion/akali/'
        },
        color: '#715b6e'
      },
      {
