export default {
  ...
  hero: {
    type: 'image',
    url: 'https://images.contentstack.io/v3/assets/blt370612131b6e0756/blt0d8831ecd72590ed/6025b5fa61513a1aa74768ac/Darius_Skin04.jpg',
    size: 'full',
    aspectMode: 'cover',
    aspectRatio: '15:13'
  },
    ...
    contents: [
      {
        ...
        action: {
          type: 'uri',
          label: '英雄介紹',
          uri: 'https://wildrift.leagueoflegends.com/zh-tw/champions/darius/'
        },
        color: '#990000'
      },
      {
        ...
        action: {
          type: 'uri',
          label: '出裝＆符文攻略',
          uri: 'https://lolwildriftbuild.com/champion/darius/'
        },
        color: '#990000'
      },
      {
