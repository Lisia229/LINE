export default {
  ...
  hero: {
    type: 'image',
    url: 'https://images.contentstack.io/v3/assets/blt370612131b6e0756/bltb370c273386a2a31/60f0943db86fce146acbdfaa/Akshan_Skin02_splash.jpg',
    size: 'full',
    aspectMode: 'cover',
    aspectRatio: '15:13'
  },
            ...
            contents: [
              ...
              },
              {
                ...
                contents: [
                  ...
                  {
                    type: 'image',
                    url: 'https://lolwildriftbuild.com/wp-content/uploads/2021/07/wits-end.jpg',
                    size: 'xxs',
                    position: 'absolute',
                    align: 'end',
                    gravity: 'top',
                  ...
                  {
                    type: 'image',
                    url: 'https://lolwildriftbuild.com/wp-content/uploads/2021/07/seryldas-grudge-1.jpg',
                    position: 'absolute',
                    size: 'xxs',
                    offsetStart: '120px'
                  },
            ...
            contents: [
              ...
              },
              {
                ...
                contents: [
                  {
                    type: 'image',
                    url: 'https://lolwildriftbuild.com/wp-content/uploads/2020/10/fleetfootwork_wild_rift.png',
                    size: 'xxs',
                    position: 'absolute',
                    align: 'start',
                    offsetStart: '0px'
    ...
    contents: [
      {
        ...
        action: {
          type: 'uri',
          label: '英雄介紹',
          uri: 'https://wildrift.leagueoflegends.com/zh-tw/champions/akshan/'
        },
        color: '#6610f2'
      },
      {
        ...
        action: {
          type: 'uri',
          label: '出裝＆符文攻略',
          uri: 'https://lolwildriftbuild.com/champion/akshan/'
        },
        color: '#6610f2'
      },
      {
